...
-------------------------------------------------
options.os_message = " "
options.kernel_message = " "
options.uptime_message = " "
options.packages_message = " "
options.resolution_message = " "
options.wm_message = " "
options.shell_message = " "
options.terminal_message = " "
options.cpu_message = " "
options.memory_message = "ﳔ "
